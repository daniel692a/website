...
var app = (function () {
    ...
    function create_fragment$b(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h41, file$a, 11, 8, 299);
    ...
    function create_default_slot$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img0, "class", "svelte-pwtaj");
    			add_location(img0, file$7, 11, 16, 343);
    			attr_dev(figure, "class", "svelte-pwtaj");
    			add_location(figure, file$7, 10, 12, 318);
    			add_location(i0, file$7, 13, 86, 499);
    			attr_dev(a0, "href", "https://studentambassadors.microsoft.com/en-US/profile/160259");
    			attr_dev(a0, "target", "_blank");
    			attr_dev(a0, "rel", "noopener noreferrer");
    			attr_dev(a0, "class", "svelte-pwtaj");
    			add_location(a0, file$7, 13, 101, 514);
    			attr_dev(a1, "href", "https://www.escom.ipn.mx/");
    			attr_dev(a1, "target", "_blank");
    			attr_dev(a1, "rel", "noopener noreferrer");
    			attr_dev(a1, "class", "svelte-pwtaj");
    			add_location(a1, file$7, 13, 282, 695);
    			add_location(i1, file$7, 13, 438, 851);
    			add_location(br, file$7, 13, 486, 899);
    			add_location(i2, file$7, 14, 84, 988);
    			...
    			attr_dev(img1, "class", "svelte-pwtaj");
    			add_location(img1, file$7, 14, 232, 1136);
    			attr_dev(p, "class", "svelte-pwtaj");
    			add_location(p, file$7, 13, 12, 425);
    			attr_dev(section, "class", "descrip svelte-pwtaj");
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(section, "class", "svelte-pwtaj");
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (!src_url_equal(img1.src, img1_src_value = Python)) attr_dev(img1, "src", img1_src_value);
    			attr_dev(img1, "alt", "Python icon");
    			...
    			if (!src_url_equal(img2.src, img2_src_value = Cplusplus)) attr_dev(img2, "src", img2_src_value);
    			attr_dev(img2, "alt", "C++ icon");
    			attr_dev(img2, "class", "svelte-187fsyc");
    			add_location(img2, file$6, 20, 16, 942);
    			attr_dev(span1, "class", "svelte-187fsyc");
    			add_location(span1, file$6, 20, 54, 980);
    			attr_dev(li1, "class", "svelte-187fsyc");
    			add_location(li1, file$6, 20, 12, 938);
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			figure = element("figure");
    			img = element("img");
    			attr_dev(section0, "class", "cards svelte-uuiist");
    			...
    			attr_dev(img, "class", "svelte-uuiist");
    			add_location(img, file$4, 67, 16, 2457);
    			attr_dev(figure, "class", "code-pic svelte-uuiist");
    			add_location(figure, file$4, 66, 12, 2415);
    			attr_dev(section1, "class", "container-projects svelte-uuiist");
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(section, "class", "svelte-uuiist");
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img2, file$3, 26, 20, 1197);
    			attr_dev(figure2, "class", "svelte-1tea8rf");
    			add_location(figure2, file$3, 25, 16, 1168);
    			attr_dev(h41, "class", "svelte-1tea8rf");
    			add_location(h41, file$3, 28, 16, 1282);
    			...
    			if (!src_url_equal(img3.src, img3_src_value = Twitter)) attr_dev(img3, "src", img3_src_value);
    			attr_dev(img3, "alt", "Twitter icon");
    			attr_dev(img3, "class", "svelte-1tea8rf");
    			add_location(img3, file$3, 34, 20, 1515);
    			attr_dev(figure3, "class", "svelte-1tea8rf");
    			add_location(figure3, file$3, 33, 16, 1486);
    			...
    			add_location(a2, file$3, 32, 12, 1386);
    			attr_dev(section2, "class", "social-link svelte-1tea8rf");
    			add_location(section2, file$3, 31, 8, 1344);
    			if (!src_url_equal(img4.src, img4_src_value = GMail)) attr_dev(img4, "src", img4_src_value);
    			attr_dev(img4, "alt", "GMail icon");
    			attr_dev(img4, "class", "svelte-1tea8rf");
    			add_location(img4, file$3, 42, 20, 1830);
    			attr_dev(figure4, "class", "svelte-1tea8rf");
    			add_location(figure4, file$3, 41, 16, 1801);
    			...
    			add_location(a3, file$3, 40, 12, 1701);
    			attr_dev(section3, "class", "social-link svelte-1tea8rf");
    			add_location(section3, file$3, 39, 8, 1659);
    			if (!src_url_equal(img5.src, img5_src_value = Medium)) attr_dev(img5, "src", img5_src_value);
    			attr_dev(img5, "alt", "Medium icon");
    			attr_dev(img5, "class", "svelte-1tea8rf");
    			add_location(img5, file$3, 50, 20, 2139);
    			attr_dev(figure5, "class", "svelte-1tea8rf");
    			add_location(figure5, file$3, 49, 16, 2110);
    			attr_dev(h44, "class", "svelte-1tea8rf");
    			add_location(h44, file$3, 52, 16, 2220);
    			attr_dev(a4, "href", "https://daniel692a.medium.com/");
    			attr_dev(a4, "target", "_blank");
    			attr_dev(a4, "rel", "noopener noreferrer");
    			attr_dev(a4, "class", "svelte-1tea8rf");
    			add_location(a4, file$3, 48, 12, 2010);
    			attr_dev(section4, "class", "social-link svelte-1tea8rf");
    			add_location(section4, file$3, 47, 8, 1968);
    			attr_dev(section5, "class", "social-container svelte-1tea8rf");
    			add_location(section5, file$3, 14, 4, 663);
    			attr_dev(section6, "class", "social-media svelte-1tea8rf");
    			attr_dev(section6, "id", "contact");
    			add_location(section6, file$3, 9, 0, 311);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h10 = element("h1");
    			h10.textContent = "Making an";
    			t1 = space();
    			h11 = element("h1");
    			h11.textContent = "Impact with technology";
    			t3 = space();
    			section = element("section");
    			figure0 = element("figure");
    			img0 = element("img");
    			...
    			img13 = element("img");
    			attr_dev(h10, "class", "title-1");
    			add_location(h10, file$2, 21, 0, 885);
    			attr_dev(h11, "class", "title-2");
    			add_location(h11, file$2, 22, 0, 920);
    			...
    			attr_dev(img0, "class", "svelte-1dg3t1i");
    			add_location(img0, file$2, 25, 8, 1035);
    			attr_dev(figure0, "class", "svelte-1dg3t1i");
    			add_location(figure0, file$2, 24, 4, 982);
    			...
    			attr_dev(img1, "class", "svelte-1dg3t1i");
    			add_location(img1, file$2, 28, 8, 1160);
    			attr_dev(figure1, "class", "svelte-1dg3t1i");
    			add_location(figure1, file$2, 27, 4, 1109);
    			...
    			attr_dev(img2, "class", "svelte-1dg3t1i");
    			add_location(img2, file$2, 31, 8, 1286);
    			attr_dev(figure2, "class", "svelte-1dg3t1i");
    			add_location(figure2, file$2, 30, 4, 1233);
    			...
    			attr_dev(img3, "class", "svelte-1dg3t1i");
    			add_location(img3, file$2, 34, 8, 1411);
    			attr_dev(figure3, "class", "svelte-1dg3t1i");
    			add_location(figure3, file$2, 33, 4, 1360);
    			...
    			attr_dev(img4, "class", "svelte-1dg3t1i");
    			add_location(img4, file$2, 37, 8, 1537);
    			attr_dev(figure4, "class", "svelte-1dg3t1i");
    			add_location(figure4, file$2, 36, 4, 1484);
    			...
    			attr_dev(img5, "class", "svelte-1dg3t1i");
    			add_location(img5, file$2, 40, 8, 1662);
    			attr_dev(figure5, "class", "svelte-1dg3t1i");
    			add_location(figure5, file$2, 39, 4, 1609);
    			...
    			attr_dev(img6, "class", "svelte-1dg3t1i");
    			add_location(img6, file$2, 43, 8, 1783);
    			attr_dev(figure6, "class", "svelte-1dg3t1i");
    			add_location(figure6, file$2, 42, 4, 1732);
    			...
    			attr_dev(img7, "class", "svelte-1dg3t1i");
    			add_location(img7, file$2, 46, 8, 1906);
    			attr_dev(figure7, "class", "svelte-1dg3t1i");
    			add_location(figure7, file$2, 45, 4, 1853);
    			...
    			attr_dev(img8, "class", "svelte-1dg3t1i");
    			add_location(img8, file$2, 49, 8, 2030);
    			attr_dev(figure8, "class", "svelte-1dg3t1i");
    			add_location(figure8, file$2, 48, 4, 1979);
    			...
    			attr_dev(img9, "class", "svelte-1dg3t1i");
    			add_location(img9, file$2, 52, 8, 2154);
    			attr_dev(figure9, "class", "svelte-1dg3t1i");
    			add_location(figure9, file$2, 51, 4, 2103);
    			...
    			attr_dev(img10, "class", "svelte-1dg3t1i");
    			add_location(img10, file$2, 55, 8, 2279);
    			attr_dev(figure10, "class", "svelte-1dg3t1i");
    			add_location(figure10, file$2, 54, 4, 2226);
    			...
    			attr_dev(img11, "class", "svelte-1dg3t1i");
    			add_location(img11, file$2, 58, 8, 2405);
    			attr_dev(figure11, "class", "svelte-1dg3t1i");
    			add_location(figure11, file$2, 57, 4, 2352);
    			...
    			attr_dev(img12, "class", "svelte-1dg3t1i");
    			add_location(img12, file$2, 61, 8, 2530);
    			attr_dev(figure12, "class", "svelte-1dg3t1i");
    			add_location(figure12, file$2, 60, 4, 2477);
    			...
    			attr_dev(img13, "class", "svelte-1dg3t1i");
    			add_location(img13, file$2, 64, 8, 2654);
    			attr_dev(figure13, "class", "svelte-1dg3t1i");
    			add_location(figure13, file$2, 63, 4, 2603);
    			attr_dev(section, "class", "svelte-1dg3t1i");
    			add_location(section, file$2, 23, 0, 968);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
