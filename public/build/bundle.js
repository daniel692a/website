...
var app = (function () {
    ...
    function create_fragment$b(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a0, "class", "svelte-1y7v1om");
    			add_location(a0, file$a, 23, 16, 578);
    			attr_dev(li0, "class", "svelte-1y7v1om");
    			add_location(li0, file$a, 23, 12, 574);
    			attr_dev(a1, "href", "#projects");
    			attr_dev(a1, "class", "svelte-1y7v1om");
    			add_location(a1, file$a, 24, 16, 647);
    			attr_dev(li1, "class", "svelte-1y7v1om");
    			add_location(li1, file$a, 24, 12, 643);
    			attr_dev(a2, "href", "#contact");
    			attr_dev(a2, "class", "svelte-1y7v1om");
    			add_location(a2, file$a, 25, 16, 722);
    			attr_dev(li2, "class", "svelte-1y7v1om");
    			add_location(li2, file$a, 25, 12, 718);
    			attr_dev(ul, "class", "nav-menu svelte-1y7v1om");
    			toggle_class(ul, "active", /*openMenu*/ ctx[2] === true);
    			add_location(ul, file$a, 22, 8, 487);
    			attr_dev(span0, "class", "bar svelte-1y7v1om");
    			toggle_class(span0, "move1", /*openMenu*/ ctx[2] === true);
    			add_location(span0, file$a, 28, 12, 881);
    			attr_dev(span1, "class", "bar svelte-1y7v1om");
    			toggle_class(span1, "enable", /*openMenu*/ ctx[2] === true);
    			add_location(span1, file$a, 29, 12, 951);
    			attr_dev(span2, "class", "bar svelte-1y7v1om");
    			toggle_class(span2, "move2", /*openMenu*/ ctx[2] === true);
    			add_location(span2, file$a, 30, 12, 1022);
    			attr_dev(section, "class", "hamburger svelte-1y7v1om");
    			attr_dev(section, "aria-label", "Menu");
    			add_location(section, file$a, 27, 8, 801);
    			add_location(nav, file$a, 21, 4, 473);
    			attr_dev(header, "class", "svelte-1y7v1om");
    			add_location(header, file$a, 20, 0, 460);
    		},
    ...
    var profile = "2d7399733d891dc9.jpg";

    /* src/Profile.svelte generated by Svelte v3.44.2 */
    const file$9 = "src/Profile.svelte";
    ...
    function create_fragment$a(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = space();
    			h40 = element("h4");
    			h40.textContent = "Computer Science";
    			t4 = space();
    			h41 = element("h4");
    			h41.textContent = "Competitive Programming";
    			if (!src_url_equal(img.src, img_src_value = profile)) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "Daniel's picture");
    			attr_dev(img, "class", "svelte-esg4gg");
    			add_location(img, file$9, 6, 8, 120);
    			attr_dev(figure, "class", "svelte-esg4gg");
    			add_location(figure, file$9, 5, 4, 103);
    			attr_dev(h2, "class", "svelte-esg4gg");
    			add_location(h2, file$9, 9, 8, 215);
    			attr_dev(h40, "class", "svelte-esg4gg");
    			add_location(h40, file$9, 10, 8, 253);
    			attr_dev(h41, "class", "svelte-esg4gg");
    			add_location(h41, file$9, 11, 8, 287);
    			attr_dev(section0, "class", "intro svelte-esg4gg");
    			add_location(section0, file$9, 8, 4, 183);
    			attr_dev(section1, "class", "presentation svelte-esg4gg");
    			add_location(section1, file$9, 4, 0, 68);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* node_modules/svelte-c-reveal/src/Reveal.svelte generated by Svelte v3.44.2 */
    const file$8 = "node_modules/svelte-c-reveal/src/Reveal.svelte";
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$8, 262, 4, 5937);
    			attr_dev(div1, "class", "wrapper svelte-19ttgh6");
    			add_location(div1, file$8, 258, 0, 5783);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src/components/Subtitle.svelte generated by Svelte v3.44.2 */
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h2, "class", "svelte-4fnyie");
    			add_location(h2, file$7, 4, 0, 44);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Subtitle extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*subtitle*/ ctx[0] === undefined && !('subtitle' in props)) {
    			console.warn("<Subtitle> was created without expected prop 'subtitle'");
    		}
    	}
    ...
    function create_default_slot$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t0 = space();
    			p = element("p");
    			t1 = text("Hello everyone, my name is Daniel, I'm a software developer located in ");
    			i0 = element("i");
    			i0.textContent = "Mexico";
    			t3 = text(", ");
    			a0 = element("a");
    			a0.textContent = "Microsoft Learn Student Ambassador";
    			t5 = text(" and Data science student at ");
    			a1 = element("a");
    			a1.textContent = "ESCOM-IPN";
    			t7 = text(", I'm passionate about the world of computer science, especially ");
    			i1 = element("i");
    			i1.textContent = "data science and competitive programming.";
    			br = element("br");
    			t9 = text("\n            I'm currently working as a Frontend developer and I'm researching about ");
    			i2 = element("i");
    			i2.textContent = "Algorithms and Data Structures";
    			t11 = text(", I collaborate in both local and national software communities. My dream is to be a Machine Learning engineer.");
    			if (!src_url_equal(img.src, img_src_value = Coding$1)) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "Desk with a computer");
    			attr_dev(img, "class", "svelte-1mel4fv");
    			add_location(img, file$6, 11, 16, 344);
    			attr_dev(figure, "class", "svelte-1mel4fv");
    			add_location(figure, file$6, 10, 12, 319);
    			add_location(i0, file$6, 13, 86, 500);
    			attr_dev(a0, "href", "https://studentambassadors.microsoft.com/en-US/profile/160259");
    			attr_dev(a0, "target", "_blank");
    			attr_dev(a0, "rel", "noopener noreferrer");
    			attr_dev(a0, "class", "svelte-1mel4fv");
    			add_location(a0, file$6, 13, 101, 515);
    			attr_dev(a1, "href", "https://www.escom.ipn.mx/");
    			attr_dev(a1, "target", "_blank");
    			attr_dev(a1, "rel", "noopener noreferrer");
    			attr_dev(a1, "class", "svelte-1mel4fv");
    			add_location(a1, file$6, 13, 282, 696);
    			add_location(i1, file$6, 13, 438, 852);
    			add_location(br, file$6, 13, 486, 900);
    			add_location(i2, file$6, 14, 84, 989);
    			attr_dev(p, "class", "svelte-1mel4fv");
    			add_location(p, file$6, 13, 12, 426);
    			attr_dev(section, "class", "descrip svelte-1mel4fv");
    			add_location(section, file$6, 9, 8, 281);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(section, "class", "svelte-1mel4fv");
    			add_location(section, file$6, 6, 0, 162);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src/Skillset.svelte generated by Svelte v3.44.2 */
    const file$5 = "src/Skillset.svelte";
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h2, "class", "svelte-1pofceo");
    			add_location(h2, file$5, 15, 4, 584);
    			attr_dev(h30, "class", "svelte-1pofceo");
    			add_location(h30, file$5, 17, 8, 638);
    			if (!src_url_equal(img0.src, img0_src_value = Python)) attr_dev(img0, "src", img0_src_value);
    			attr_dev(img0, "alt", "Python icon");
    			attr_dev(img0, "class", "svelte-1pofceo");
    			add_location(img0, file$5, 19, 16, 699);
    			attr_dev(span0, "class", "svelte-1pofceo");
    			add_location(span0, file$5, 19, 54, 737);
    			attr_dev(li0, "class", "svelte-1pofceo");
    			add_location(li0, file$5, 19, 12, 695);
    			if (!src_url_equal(img1.src, img1_src_value = Cplusplus)) attr_dev(img1, "src", img1_src_value);
    			attr_dev(img1, "alt", "C++ icon");
    			attr_dev(img1, "class", "svelte-1pofceo");
    			add_location(img1, file$5, 20, 16, 778);
    			attr_dev(span1, "class", "svelte-1pofceo");
    			add_location(span1, file$5, 20, 54, 816);
    			attr_dev(li1, "class", "svelte-1pofceo");
    			add_location(li1, file$5, 20, 12, 774);
    			if (!src_url_equal(img2.src, img2_src_value = JavaScript)) attr_dev(img2, "src", img2_src_value);
    			attr_dev(img2, "alt", "JavaScript Icon");
    			attr_dev(img2, "class", "svelte-1pofceo");
    			add_location(img2, file$5, 21, 16, 854);
    			attr_dev(span2, "class", "svelte-1pofceo");
    			add_location(span2, file$5, 21, 62, 900);
    			attr_dev(li2, "class", "svelte-1pofceo");
    			add_location(li2, file$5, 21, 12, 850);
    			attr_dev(ul0, "class", "svelte-1pofceo");
    			add_location(ul0, file$5, 18, 8, 678);
    			attr_dev(h31, "class", "svelte-1pofceo");
    			add_location(h31, file$5, 23, 8, 951);
    			if (!src_url_equal(img3.src, img3_src_value = React)) attr_dev(img3, "src", img3_src_value);
    			attr_dev(img3, "alt", "Reactjs icon");
    			attr_dev(img3, "title", "ReactJs");
    			attr_dev(img3, "class", "svelte-1pofceo");
    			add_location(img3, file$5, 25, 16, 1005);
    			attr_dev(span3, "class", "svelte-1pofceo");
    			add_location(span3, file$5, 25, 70, 1059);
    			attr_dev(li3, "class", "svelte-1pofceo");
    			add_location(li3, file$5, 25, 12, 1001);
    			if (!src_url_equal(img4.src, img4_src_value = Svelte)) attr_dev(img4, "src", img4_src_value);
    			attr_dev(img4, "alt", "Sveltejs icon");
    			attr_dev(img4, "title", "Sveltejs");
    			attr_dev(img4, "class", "svelte-1pofceo");
    			add_location(img4, file$5, 26, 16, 1101);
    			attr_dev(span4, "class", "svelte-1pofceo");
    			add_location(span4, file$5, 26, 73, 1158);
    			attr_dev(li4, "class", "svelte-1pofceo");
    			add_location(li4, file$5, 26, 12, 1097);
    			attr_dev(ul1, "class", "svelte-1pofceo");
    			add_location(ul1, file$5, 24, 8, 984);
    			attr_dev(h32, "class", "svelte-1pofceo");
    			add_location(h32, file$5, 28, 8, 1207);
    			if (!src_url_equal(img5.src, img5_src_value = FastAPI)) attr_dev(img5, "src", img5_src_value);
    			attr_dev(img5, "alt", "FastAPI icon");
    			attr_dev(img5, "class", "svelte-1pofceo");
    			add_location(img5, file$5, 30, 16, 1260);
    			attr_dev(span5, "class", "svelte-1pofceo");
    			add_location(span5, file$5, 30, 56, 1300);
    			attr_dev(li5, "class", "svelte-1pofceo");
    			add_location(li5, file$5, 30, 12, 1256);
    			if (!src_url_equal(img6.src, img6_src_value = Flask)) attr_dev(img6, "src", img6_src_value);
    			attr_dev(img6, "alt", "Flask icon");
    			attr_dev(img6, "class", "svelte-1pofceo");
    			add_location(img6, file$5, 31, 16, 1342);
    			attr_dev(span6, "class", "svelte-1pofceo");
    			add_location(span6, file$5, 31, 52, 1378);
    			attr_dev(li6, "class", "svelte-1pofceo");
    			add_location(li6, file$5, 31, 12, 1338);
    			attr_dev(ul2, "class", "svelte-1pofceo");
    			add_location(ul2, file$5, 29, 8, 1239);
    			attr_dev(h33, "class", "svelte-1pofceo");
    			add_location(h33, file$5, 33, 8, 1424);
    			if (!src_url_equal(img7.src, img7_src_value = NumPy)) attr_dev(img7, "src", img7_src_value);
    			attr_dev(img7, "alt", "NumPy icon");
    			attr_dev(img7, "class", "svelte-1pofceo");
    			add_location(img7, file$5, 35, 16, 1472);
    			attr_dev(span7, "class", "svelte-1pofceo");
    			add_location(span7, file$5, 35, 52, 1508);
    			attr_dev(li7, "class", "svelte-1pofceo");
    			add_location(li7, file$5, 35, 12, 1468);
    			if (!src_url_equal(img8.src, img8_src_value = Pandas)) attr_dev(img8, "src", img8_src_value);
    			attr_dev(img8, "alt", "Pandas icon");
    			attr_dev(img8, "class", "svelte-1pofceo");
    			add_location(img8, file$5, 36, 16, 1548);
    			attr_dev(span8, "class", "svelte-1pofceo");
    			add_location(span8, file$5, 36, 54, 1586);
    			attr_dev(li8, "class", "svelte-1pofceo");
    			add_location(li8, file$5, 36, 12, 1544);
    			if (!src_url_equal(img9.src, img9_src_value = ScikitLearn)) attr_dev(img9, "src", img9_src_value);
    			attr_dev(img9, "alt", "ScikitLearn icon");
    			attr_dev(img9, "class", "svelte-1pofceo");
    			add_location(img9, file$5, 37, 16, 1627);
    			attr_dev(li9, "class", "svelte-1pofceo");
    			add_location(li9, file$5, 37, 12, 1623);
    			if (!src_url_equal(img10.src, img10_src_value = TensorFlow)) attr_dev(img10, "src", img10_src_value);
    			attr_dev(img10, "alt", "TensorFlow icon");
    			attr_dev(img10, "class", "svelte-1pofceo");
    			add_location(img10, file$5, 38, 16, 1708);
    			attr_dev(span9, "class", "svelte-1pofceo");
    			add_location(span9, file$5, 38, 62, 1754);
    			attr_dev(li10, "class", "svelte-1pofceo");
    			add_location(li10, file$5, 38, 12, 1704);
    			attr_dev(ul3, "class", "svelte-1pofceo");
    			add_location(ul3, file$5, 34, 8, 1451);
    			attr_dev(section0, "class", "tools svelte-1pofceo");
    			add_location(section0, file$5, 16, 4, 606);
    			attr_dev(section1, "class", "skillset svelte-1pofceo");
    			add_location(section1, file$5, 14, 0, 553);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src/components/Project.svelte generated by Svelte v3.44.2 */
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$4, 7, 12, 177);
    			attr_dev(figure, "class", "svelte-1yv6d7b");
    			add_location(figure, file$4, 6, 8, 156);
    			attr_dev(h5, "class", "svelte-1yv6d7b");
    			add_location(h5, file$4, 9, 8, 244);
    			attr_dev(a, "href", /*url*/ ctx[1]);
    			attr_dev(a, "target", "_blank");
    			attr_dev(a, "rel", "noopener noreferrer");
    			attr_dev(a, "class", "svelte-1yv6d7b");
    			add_location(a, file$4, 5, 4, 91);
    			attr_dev(section, "class", "card svelte-1yv6d7b");
    			add_location(section, file$4, 4, 0, 64);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    // (33:4) <Reveal reveal='fadeInRight' duration='1'>
    function create_default_slot(ctx) {
    	...
    	project = new Project({
    			props: {
    				name: /*projects*/ ctx[0][0].name,
    				url: /*projects*/ ctx[0][0].url,
    	...
    	const block = {
    		c: function create() {
    			...
    			figure = element("figure");
    			img = element("img");
    			attr_dev(section0, "class", "cards svelte-11rl38z");
    			add_location(section0, file$3, 34, 12, 1112);
    			if (!src_url_equal(img.src, img_src_value = Coding)) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "Boy showing code");
    			attr_dev(img, "class", "svelte-11rl38z");
    			add_location(img, file$3, 38, 16, 1322);
    			attr_dev(figure, "class", "code-pic svelte-11rl38z");
    			add_location(figure, file$3, 37, 12, 1280);
    			attr_dev(section1, "class", "container-projects svelte-11rl38z");
    			add_location(section1, file$3, 33, 8, 1063);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, section1, anchor);
    			append_dev(section1, section0);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(33:4) <Reveal reveal='fadeInRight' duration='1'>",
    		ctx
    	});
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			create_component(reveal.$$.fragment);
    			attr_dev(h2, "class", "svelte-11rl38z");
    			add_location(h2, file$3, 31, 4, 990);
    			attr_dev(section, "id", "projects");
    			attr_dev(section, "class", "svelte-11rl38z");
    			add_location(section, file$3, 30, 0, 962);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src/SocialMedia.svelte generated by Svelte v3.44.2 */
    const file$2 = "src/SocialMedia.svelte";
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			h2 = element("h2");
    			h2.textContent = "Contact with me😄";
    			t1 = space();
    			...
    			t14 = space();
    			h44 = element("h4");
    			h44.textContent = "Medium";
    			attr_dev(h2, "class", "svelte-p5nt3h");
    			add_location(h2, file$2, 9, 4, 302);
    			if (!src_url_equal(img0.src, img0_src_value = GitHub)) attr_dev(img0, "src", img0_src_value);
    			attr_dev(img0, "alt", "GitHub icon");
    			attr_dev(img0, "class", "svelte-p5nt3h");
    			add_location(img0, file$2, 14, 20, 546);
    			attr_dev(figure0, "class", "svelte-p5nt3h");
    			add_location(figure0, file$2, 13, 16, 517);
    			attr_dev(h40, "class", "svelte-p5nt3h");
    			add_location(h40, file$2, 16, 16, 627);
    			attr_dev(a0, "href", "https://github.com/daniel692a");
    			attr_dev(a0, "target", "_blank");
    			attr_dev(a0, "rel", "noopener noreferrer");
    			attr_dev(a0, "class", "svelte-p5nt3h");
    			add_location(a0, file$2, 12, 12, 418);
    			attr_dev(section0, "class", "social-link svelte-p5nt3h");
    			add_location(section0, file$2, 11, 8, 376);
    			if (!src_url_equal(img1.src, img1_src_value = LinkedIn)) attr_dev(img1, "src", img1_src_value);
    			attr_dev(img1, "alt", "LinkedIn icon");
    			attr_dev(img1, "class", "svelte-p5nt3h");
    			add_location(img1, file$2, 22, 20, 867);
    			attr_dev(figure1, "class", "svelte-p5nt3h");
    			add_location(figure1, file$2, 21, 16, 838);
    			attr_dev(h41, "class", "svelte-p5nt3h");
    			add_location(h41, file$2, 24, 16, 952);
    			attr_dev(a1, "href", "https://www.linkedin.com/in/daniel692a/");
    			attr_dev(a1, "target", "_blank");
    			attr_dev(a1, "rel", "noopener noreferrer");
    			attr_dev(a1, "class", "svelte-p5nt3h");
    			add_location(a1, file$2, 20, 12, 729);
    			attr_dev(section1, "class", "social-link svelte-p5nt3h");
    			add_location(section1, file$2, 19, 8, 687);
    			if (!src_url_equal(img2.src, img2_src_value = Twitter)) attr_dev(img2, "src", img2_src_value);
    			attr_dev(img2, "alt", "Twitter icon");
    			attr_dev(img2, "class", "svelte-p5nt3h");
    			add_location(img2, file$2, 30, 20, 1185);
    			attr_dev(figure2, "class", "svelte-p5nt3h");
    			add_location(figure2, file$2, 29, 16, 1156);
    			attr_dev(h42, "class", "svelte-p5nt3h");
    			add_location(h42, file$2, 32, 16, 1268);
    			attr_dev(a2, "href", "https://twitter.com/daniel692a");
    			attr_dev(a2, "target", "_blank");
    			attr_dev(a2, "rel", "noopener noreferrer");
    			attr_dev(a2, "class", "svelte-p5nt3h");
    			add_location(a2, file$2, 28, 12, 1056);
    			attr_dev(section2, "class", "social-link svelte-p5nt3h");
    			add_location(section2, file$2, 27, 8, 1014);
    			if (!src_url_equal(img3.src, img3_src_value = GMail)) attr_dev(img3, "src", img3_src_value);
    			attr_dev(img3, "alt", "GMail icon");
    			attr_dev(img3, "class", "svelte-p5nt3h");
    			add_location(img3, file$2, 38, 20, 1500);
    			attr_dev(figure3, "class", "svelte-p5nt3h");
    			add_location(figure3, file$2, 37, 16, 1471);
    			attr_dev(h43, "class", "svelte-p5nt3h");
    			add_location(h43, file$2, 40, 16, 1579);
    			attr_dev(a3, "href", "mailto:daniel62armas@gmail.com");
    			attr_dev(a3, "target", "_blank");
    			attr_dev(a3, "rel", "noopener noreferrer");
    			attr_dev(a3, "class", "svelte-p5nt3h");
    			add_location(a3, file$2, 36, 12, 1371);
    			attr_dev(section3, "class", "social-link svelte-p5nt3h");
    			add_location(section3, file$2, 35, 8, 1329);
    			if (!src_url_equal(img4.src, img4_src_value = Medium)) attr_dev(img4, "src", img4_src_value);
    			attr_dev(img4, "alt", "Medium icon");
    			attr_dev(img4, "class", "svelte-p5nt3h");
    			add_location(img4, file$2, 46, 20, 1809);
    			attr_dev(figure4, "class", "svelte-p5nt3h");
    			add_location(figure4, file$2, 45, 16, 1780);
    			attr_dev(h44, "class", "svelte-p5nt3h");
    			add_location(h44, file$2, 48, 16, 1890);
    			attr_dev(a4, "href", "https://daniel692a.medium.com/");
    			attr_dev(a4, "target", "_blank");
    			attr_dev(a4, "rel", "noopener noreferrer");
    			attr_dev(a4, "class", "svelte-p5nt3h");
    			add_location(a4, file$2, 44, 12, 1680);
    			attr_dev(section4, "class", "social-link svelte-p5nt3h");
    			add_location(section4, file$2, 43, 8, 1638);
    			attr_dev(section5, "class", "social-container svelte-p5nt3h");
    			add_location(section5, file$2, 10, 4, 333);
    			attr_dev(section6, "class", "social-media svelte-p5nt3h");
    			attr_dev(section6, "id", "contact");
    			add_location(section6, file$2, 8, 0, 254);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(section6, h2);
    			append_dev(section6, t1);
    			append_dev(section6, section5);
    			append_dev(section5, section0);
    			append_dev(section0, a0);
    			append_dev(a0, figure0);
    			append_dev(figure0, img0);
    			append_dev(a0, t2);
    			append_dev(a0, h40);
    			append_dev(section5, t4);
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ GitHub, LinkedIn, Twitter, GMail, Medium });
    	return [];
    }
    ...
    /* src/Footer.svelte generated by Svelte v3.44.2 */
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			h4 = element("h4");
    			h4.textContent = "Made with 💖 by Daniel Armas";
    			attr_dev(h4, "class", "svelte-bmr52h");
    			add_location(h4, file, 5, 4, 34);
    			attr_dev(footer, "class", "svelte-bmr52h");
